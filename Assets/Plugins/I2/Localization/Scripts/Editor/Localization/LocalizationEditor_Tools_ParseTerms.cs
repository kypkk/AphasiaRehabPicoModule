	...
	public partial class LocalizationEditor
	{
		...
		static void FindTermsInCurrentScene()
		{
			...
			for (int i=0, imax=Locals.Length; i<imax; ++i)
			{
                ...
                if (localize==null || (localize.Source!=null && localize.Source.mSource!=mLanguageSource) || localize.gameObject==null || !GUITools.ObjectExistInScene(localize.gameObject))
					continue;
