...
public class LabCombinedEyeData : LabDataBase
{
    /** 眼睛凝视点，基于右手坐标系*/
...
#if USE_SRANIPAL
    public LabCombinedEyeData(SingleEyeData data)
    {
    ...
    public LabCombinedEyeData(Pvr_UnitySDKAPI.EyeTrackingData data)
    {
        // 不確定串的值是不是對的
        gaze_origin_mm = data.combinedEyeGazePoint.ToPos();
        gaze_direction_normalized = data.combinedEyeGazeVector.ToPos();
        
        // 以下空白
        // pupil_diameter_mm = data.combinedEyePupilDilation;
        // eye_openness = data.combinedEyeOpenness;
        // pupil_position_in_sensor_area = data.combinedEyePositionGuide; 
    }
#endif

    public LabCombinedEyeData(
